...
export function Avatar({ animation = 'typing', ...props }) {
  ...
  // 2. Load the external Mixamo animation files (with fallback for casing)
  ...
  useEffect(() => {
    // Find the requested action ('typing' or 'waving'), fallback to the first available clip
...
// Preload the base avatar model and both animation clips for instantaneous zero-lag mounting
